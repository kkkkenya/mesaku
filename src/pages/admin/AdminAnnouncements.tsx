  ...
  if (mode === "form") {
    return (
      <div className="max-w-2xl">
        <h1 className="font-heading text-2xl font-bold text-[#1E3A8A] mb-6">
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-heading text-2xl font-bold text-[#1E3A8A]">Announcements</h1>
        <button
          onClick={startCreate}
          className="bg-[#1E3A8A] text-white px-4 h-10 rounded-md font-medium flex items-center gap-2"
        >
